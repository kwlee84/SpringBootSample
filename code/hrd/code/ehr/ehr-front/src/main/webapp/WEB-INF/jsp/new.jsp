...
<body>
	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="#">교육과정 등록</a>
		</div>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<h1 class="page-header">교육과정 등록</h1>
				<div class="col-md-5">
					<form action="/temp/save" method="post" modelAttribute="courseForm">
						...
						<div class="form-group">
							<label for="institueName">과정종류(Institue Name)</label> <input
								...
								name="institueName" placeholder="Institue Name">
						</div>
